...
///文档说明
///带进度条的下载按钮
///https://flutter.cn/docs/cookbook/effects/download-button

class DownloadButtonPage extends StatefulWidget {
  const DownloadButtonPage({super.key});
  static String routeName = '/effects/DownloadButtonPage';
...
class _DownloadButtonPageState extends State<DownloadButtonPage> {
  ...
  void _onOpenDownload(int index) {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(SnackBar(content: Text("打开APP $index")));
  }
  ...
  @override
  void didUpdateWidget(DownloadButtonPage oldWidget) {
